...
public class FraisHfAdapter extends BaseAdapter {
	...
	public View getView(int index, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
            ...
            holder.cmdSupprReturn = (ImageButton)convertView.findViewById(R.id.cmdSupprReturn);
        ...
        holder.cmdSupprReturn.setTag(index);
        holder.cmdSupprReturn.setOnClickListener(new OnClickListener() {
            @Override
